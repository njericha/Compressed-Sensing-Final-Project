...
# ╔═╡ db011177-6be3-4671-b194-55c590827dd6
using LinearAlgebra

# ╔═╡ b54398a5-e03a-4811-a2ed-17dc22825863
using Random

# ╔═╡ 02ea659e-6211-477e-9703-ebb5cc860dee
using Einsum
...
# ╔═╡ 760422ed-7f97-48d5-971d-1ad8b116c06f
x=randn(n)

# ╔═╡ d11b6fcb-41a6-489e-b4a4-acf96d783c89
@einsum b[k] := (A[i,k]*x[i])^2

# ╔═╡ 942b0164-5990-4c8b-bddf-042d7cfe25b5
begin 
	y=abs.(randn(m))
	y=y/(b'y)
end
...
# ╔═╡ 778917bf-7237-439c-ad3c-261e5062a04c
λ2_estimate = y'l - maximum(y.*l)

# ╔═╡ fd3bb687-df4a-43b8-ab93-08629fef7b79
λ1_estimate/λ2_estimate

# ╔═╡ 3aed0da7-8268-46f1-a2e9-1f4f2ba21f89
λ1_estimate-λ2_estimate

# ╔═╡ ff228e06-28f3-4a9d-b2d4-01078168fcd7
b'y

# ╔═╡ 7eb6eaad-7ca7-4cd5-9382-035513199556
@einsum AA[i,j,k] := A[i,k]*A[j,k]
...
# ╔═╡ ada2dfdc-3eb0-46e5-8bb2-74b2cd0e1403
λ[1]/λ[2]

# ╔═╡ 2d79e039-55d7-435f-b30e-b418c6068e6b
λ[1]-λ[2]

# ╔═╡ 47ae6bdb-6a6d-448c-92e7-23cf3cd368ca
λ[1]

# ╔═╡ 2da65eb2-5c61-41f6-a71c-479535812579
plot(λ)
